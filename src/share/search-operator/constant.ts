...
export const DEFAULT_SEARCH_OPERATOR = [
  ...
  { key: "date:eq", label: "=", type: "date", inputType: SINGLE_DATE },
  { key: "date:neq", label: "≠", type: "date", inputType: SINGLE_DATE },
  { key: "date:gt", label: ">", type: "date", inputType: SINGLE_DATE },
  { key: "date:lt", label: "<", type: "date", inputType: SINGLE_DATE },
  { key: "date:gte", label: "≧", type: "date", inputType: SINGLE_DATE },
  { key: "date:lte", label: "≦", type: "date", inputType: SINGLE_DATE },
  { key: "date:is_null", label: "is null", type: "date", inputType: NONE },
  {
    key: "date:is_not_null",
    label: "is not null",
    type: "date",
    inputType: NONE,
  },
